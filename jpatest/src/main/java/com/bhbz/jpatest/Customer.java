...
public class Customer {
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "CustomerGenerator", sequenceName = "seq_customer", allocationSize = 20)
    @GeneratedValue(generator = "CustomerGenerator", strategy = GenerationType.SEQUENCE)
    private int id;
     ...
     * @param address
     */
    public Customer(String userName, int age, String address, int type) {
	//		this.id = id;
